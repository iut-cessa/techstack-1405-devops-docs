...
5. در بخش تنظیم نمایه، نام کامل خود، یک نام کاربری کوتاه و گذرواژه‌ای قوی تعیین کنید. در قسمت `server name (hostname)` نیز یک hostname معتبر، مانند `devops-lab`، وارد کنید. در ادامه به جای کاربر `root` با این کاربر وارد شوید
